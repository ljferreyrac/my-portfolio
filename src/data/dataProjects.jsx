    ...
    return ([
        {
            ...
            description: t("Projects.ProjectsItem.PortfolioDesc")
        },
        {
            title: 'Calendar App',
            skills: 
            ...
            description: t("Projects.ProjectsItem.CalendarDesc")
        },
        {
            title: 'Journal App',
            skills: 
            ...
            description: t("Projects.ProjectsItem.JournalDesc")
        },
        {
            title: 'Heroes App',
            skills: 
            ...
            description: t("Projects.ProjectsItem.HeroesDesc")
        },
        {
            title: 'Gif App',
            skills: 
            ...
            description: t("Projects.ProjectsItem.GifDesc")
        },
        {
            ...
            description: t("Projects.ProjectsItem.CreditDesc")
        }
    ])
} 
